...
from .fitting import polynomial_least_square_fitting, apply_finite_strain_fitting
# from qha.type_aliases import Vector, Matrix
from .unit_conversion import gpa_to_ry_b3
...
class VolumeExpander:
    ...
    **Note:** To use this class, the method ``interpolate_volumes`` must be called immediately after
    ...
    def __init__(self, in_volumes, out_volumes_num: int, ratio: float):
...
class FinerGrid:
    ...
    def approach_to_best_ratio(self, volumes, free_energies, initial_ratio: float) -> float:
        """
    ...
    def refine_grid(self, volumes, free_energies,

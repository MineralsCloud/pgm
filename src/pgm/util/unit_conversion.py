...
def cm3_mol_to_b3(value):
    """
    convert the volume of cm^3/mol to bohr^3
    :param value: volume in cm^3/mol
    :return: volume in bohr^3
    volume = (Sqrt[3]/2)*(a^2)*c
    """
    return 1e24 / Avogadro * value * (angstrom / BOHR) ** 3
...
def ry_to_kb(value):
    ...
    :return: the converted value.
    """
    return value * Avogadro * RY_J / 8.31446261815324
